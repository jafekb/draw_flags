...
class SubdivisionFlagCollector(WikipediaScraper):
    ...
    SUBDIVISION_SOURCES = [
        ...
        # Germany
        {"page": "Flags_of_German_states", "country": "Germany", "subdivision_type": "state"},
        # Russia
        {
        ...
        # India
        {"page": "List_of_Indian_flags", "country": "India", "subdivision_type": "state/territory"},
        # Mexico
        {"page": "Flags_of_the_states_of_Mexico", "country": "Mexico", "subdivision_type": "state"},
        # Brazil
        {"page": "Flags_of_Brazil", "country": "Brazil", "subdivision_type": "state"},
        # China
        {"page": "Flags_of_China", "country": "China", "subdivision_type": "province/region"},
        # Japan
        {"page": "List_of_Japanese_flags", "country": "Japan", "subdivision_type": "prefecture"},
        # Spain
        {
        ...
        # Italy
        {"page": "List_of_Italian_flags", "country": "Italy", "subdivision_type": "region"},
        # United Kingdom
        {
        ...
        # France
        {"page": "List_of_French_flags", "country": "France", "subdivision_type": "region"},
        # Argentina
        {"page": "List_of_Argentine_flags", "country": "Argentina", "subdivision_type": "province"},
        # South Africa
        {
        ...
        # Austria
        {"page": "List_of_Austrian_flags", "country": "Austria", "subdivision_type": "state"},
        # Poland
        {"page": "List_of_Polish_flags", "country": "Poland", "subdivision_type": "voivodeship"},
        # Indonesia
        {
        ...
        # Malaysia
        {"page": "List_of_Malaysian_flags", "country": "Malaysia", "subdivision_type": "state"},
        # Pakistan
        {
        ...
        # Nigeria
        {"page": "List_of_Nigerian_flags", "country": "Nigeria", "subdivision_type": "state"},
        # Ukraine
        {
    ...
    def collect(self) -> List[Flag]:
        ...
        for source in self.SUBDIVISION_SOURCES:
            ...
            self._collect_from_page(source["page"], source["country"], source["subdivision_type"])
