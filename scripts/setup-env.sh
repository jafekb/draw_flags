...
git lfs pull --include "backend/models/clip-text-encoder.onnx,backend/data/comprehensive_flags_3/embeddings.npy,backend/data/national_flags/embeddings.npy" \
